    ...
    public function up(): void
    {
        Schema::table('lapangan', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('lapangan', 'harga_sewa')) {
                $table->decimal('harga_sewa', 10, 2)->nullable()->after('nama_lapangan');
            }
            ...
            if (!Schema::hasColumn('lapangan', 'tiket_tersedia')) {
                ...
                $column = $table->integer('tiket_tersedia')->default(10);
            ...
            if (!Schema::hasColumn('lapangan', 'fasilitas')) {
                $afterColumn = Schema::hasColumn('lapangan', 'tiket_tersedia') ? 'tiket_tersedia' : null;

                $column = $table->text('fasilitas')->nullable();
